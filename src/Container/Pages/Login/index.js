        ...
        <PageWrapper>
            ...
            <ImageBackground
                ...
                <View style={{ flex: 1, justifyContent: 'space-between', alignItems: 'flex-start', paddingHorizontal: '5%', paddingVertical: '10%' }}>
                    <MyText fontSize={45} bold color={colors.zircon} opacity={.9} numberOfLines={6}>Bring wacana to reality{`\n\n`}<MyText large color={colors.shark} opacity={.8}>    </MyText></MyText>
                    <View style={{ borderRadius: 15, overflow: "hidden", flex: 1, width: "100%" }}>
                        <BlurView
                            ...
                            <View style={{ flex: 1, backgroundColor: 'transparent', padding: '5%', justifyContent: 'center' }}>
                                ...
                                <MyText small color={colors.zircon} opacity={.9} style={{ marginBottom: 20 }}>Gak punya akun? <MyText small bold color={colors.caribbeanGreen} onPress={() => log('Daftar')} >sini daftar dulu.</MyText></MyText>
                                ...
                                <MyText small color={colors.zircon} opacity={.9} style={{ marginVertical: 15 }}>Gak bisa masuk? <MyText onPress={() => log('Reset')} small bold color={colors.caribbeanGreen}>kesini dulu deh.</MyText></MyText>
                            </View>
                        </BlurView>
                    </View>
                </View>
