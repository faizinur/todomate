...
export default memo(props => {
    ...
    const textStyles = {
        ...
        fontSize: 'xSmall' in props ? 10 : ('small' in props ? 12 : ('large' in props ? 16 : ('xLarge' in props ? 18 : 14))),
        fontWeight: 'bold' in props ? 'bold' : ('light' in props ? '300' : 'normal'),
        fontFamily: 'ReadexProRegular',
        lineHeight: 'xSmall' in props ? 12 : ('small' in props ? 16 : ('large' in props ? 20 : ('xLarge' in props ? 22 : 18))),
